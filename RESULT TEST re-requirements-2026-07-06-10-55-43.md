# Requirements export: RE Interview Assistant
Generated 2026-07-06 10:55:43
...
Trace: "The tool is like a mentor or consultant, who could at the right moment, give recommendations to ask follow up questions." (Stakeholder)
...
Trace: "Tool should stick to live meeting, but there is option to deactivate live feedback, the live direct feedback feature is default though." (Stakeholder)
...
Trace: "the summary of the interview are sometimes insufficient, so the tool needs to create as much as a summary that are valuable to the whole team." (Stakeholder)
...
Trace: "Tools make suggestions based on discussion between interviewers, and the suggestions always have references to which part of conversation/discussion being made." (Stakeholder)
...
Trace: "the tool needs to be able to connect the pattern of the issue, so that there will be no unnecessary repetition." (Stakeholder)
...
Trace: "Tools should handle conflicting suggestions and be able to ask follow up questions." (Stakeholder)
...
Trace: "Nothing is automatically changed in the current or precious artifacts that were stored, there is a legal aspect to it. Cannot alter automatically." (Stakeholder)
...
Trace: "source of truth is backlog, model and share points, if there are new artifacts we just add up to it." (Stakeholder)
...
Trace: "Needs approval, needs a log of changes in interview, who is accessible to the developer, not only the 'project log'." (Stakeholder)
...
Trace: "People approve hallucination requirements; this has to be avoided, this is the worst case. This will jeopardize the 'main goals'" (Stakeholder)
...
Trace: "Maximum 4-5 people during one interview." (Stakeholder)
...
Trace: "the system should make perfect sense by default, like already pre educated by default." (Stakeholder)
...
Trace: "following German regulation" (Stakeholder)
...
Trace: "The database (interview transcript) should be somewhere local, not cloud,, actually he doesnt really care! :)" (Stakeholder)
